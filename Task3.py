...
questionLength = np.array([len(question) for question in questionsColumn])
X_combined = hstack([Question_tf_idf, questionLength.reshape(-1, 1)])

# Split the data into training and testing sets
X_train, X_test, y_train, y_test = train_test_split(X_combined, labelsColumn, test_size=0.3, random_state=42, stratify=None)
